...
!main_init:                                         //
    ...
    sei                                             // 
!draw_playfield:                                    // 
    displayText(text_border1,2,2)                   //
    displayText(text_border3,20,2)                  //
    ldx #2                                          // 
...
!drawloop:
    ...
    lda #<(text_border2)                            // store the lowbyte of the text location in zero page address $fb
...
!drawArrow:                                         // 
    ...
    sta $d025                                       //
    lda #13                                         // color of the light
    sta $d026                                       //
                                                    //
    lda #0                                          // colorize sprites body BLACK
    sta $d027                                       //
                                                    //
    lda #120                                        // positioning sprites
    sta $d000                                       // #0. sprite X low byte
    lda #130                                        //
    sta $d001                                       // #0. sprite Y
                                                    //
    lda #$00                                        // X coordinate high bits
    sta $d010                                       //
                                                    //
                                                    // expand sprites
    lda #$00                                        //
...
!read_stick2:                                       //
    ...
    cmp #127                                        // middle position
    bne !+                                          //
    jsr !are_we_connected+                          //
    jsr !clear_arrows-    
    jmp !read_stick2-    
